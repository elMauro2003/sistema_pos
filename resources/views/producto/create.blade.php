            ...
            <form action="{{ route('productos.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select data-live-search="true" title="Seleccione una marca" data-size='4' name="marca_id"
                    ...
                    <div class="col-md-6">
                        ...
                        <select data-live-search="true" title="Seleccione una presentacion" data-size='4'
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select data-live-search="true" title="Seleccione una categoría" data-size='4' name="categorias[]"
