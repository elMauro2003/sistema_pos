            ...
            <form action="{{route('categorias.update',['categoria'=>$categoria])}}" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <textarea type="textarea" class="form-control" name="descripcion" id="descripcion" cols="30" rows="10">{{old('descripcion',$categoria->caracteristica->descripcion)}}</textarea>
                    </div>
                </div>
                <hr>
